...
- Goto the `htdocs` folder of your XAMPP installation directory and clone the repo to yout local machine
  ...
  - `git clone https://github.com/sudhay23/MediMeds-Web-App.git`
...
- Configure `.env` file
  ...
  - Update `.env.sample` to `.env` file under `MediMeds-Web-App/With PHP/backend/`
...
- Now you can visit the site:
  ...
  > http://localhost/MediMeds-Web-App/

  ![MediMeds-Web-App](https://user-images.githubusercontent.com/16044116/135674936-59d1d1a9-7be0-4eac-a4db-f81baf0f61ae.png)
